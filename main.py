...
#-----------------------------------ZONA DE ENTRYS DE INTERVALOS DE TIEMPO
...
#METODO PARA ACTUALIZAR LOS ENTRYS
def act():
...
#---ZONA DEL FRAME  METODOS DE SOLUCION
color_labelF='#084DA6'
colorTextoF='#f7f7f7'
...
btn_exportar = tk.Button(master= window, bg="#021526",
                   fg=colorTexto,
                   relief='flat',
                   font=('Roboto',11), width=10,text="Exportar",command=exportar).place(x=350,y=650)
btn_Clean = tk.Button(master =window,
                   bg="#021526",
                   fg=colorTexto,
                   relief='flat',
                   font=('Roboto',11), width=10,text="Clean",command=clean).place(x=450,y=650)
btn_importar = tk.Button(master =window,
                   bg="#021526",
                   fg=colorTexto,
                   relief='flat',
                   font=('Roboto',11), width=10,text="Importar",command=importar).place(x=550,y=650)
